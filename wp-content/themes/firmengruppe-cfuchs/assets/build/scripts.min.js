...
var map = {
	"./cfuchs-google-map-consent.js": "./assets/src/js/partials/cfuchs-google-map-consent.js",
	"./load-more-jobs.js": "./assets/src/js/partials/load-more-jobs.js",
	"./load-more-projects.js": "./assets/src/js/partials/load-more-projects.js",
	"./load-more-reference.js": "./assets/src/js/partials/load-more-reference.js",
...
(function () {
  ...
  function hasThirdPartyConsent() {
    ...
    try {
      const preferences = JSON.parse(decodedValue);
      return String(preferences.thirdparty) === '1' || preferences.thirdparty === true;
    } catch (error) {
      return /["']?thirdparty["']?\s*[:=]\s*["']?(?:1|true)["']?/i.test(decodedValue);
    }
  }
  ...
  function initMaps() {
    ...
    const mapWrappers = document.querySelectorAll(mapSelector);
    mapWrappers.forEach(mapWrapper => {
      if (mapWrapper.dataset.mapInitialized === 'true') {
        return;
      }
      ...
      const latitude = Number(mapWrapper.dataset.latitude);
      const longitude = Number(mapWrapper.dataset.longitude);
      if (!Number.isFinite(latitude) || !Number.isFinite(longitude)) {
        console.error('CFuchs map coordinates are invalid.');
        return;
      }
   ...
   */
  function loadApi() {
    const firstMap = document.querySelector(mapSelector);
    if (!firstMap) {
      return;
    }
    if (window.google && window.google.maps) {
    ...
    if (apiLoading || document.getElementById('cfuchs-google-maps-api')) {
      return;
    }
    const apiKey = firstMap.dataset.apiKey;
    if (!apiKey) {
      console.error('CFUCHS Google Maps API key is missing.');
      firstMap.classList.add('has-map-error');
      return;
    }
    apiLoading = true;
    ...
    script.async = true;
    script.defer = true;
    script.src = 'https://maps.googleapis.com/maps/api/js' + `?key=${encodeURIComponent(apiKey)}` + '&callback=cfuchsInitGoogleMaps' + '&loading=async';
    script.onerror = function () {
      apiLoading = false;
      document.querySelectorAll(mapSelector).forEach(mapWrapper => {
        mapWrapper.classList.add('has-map-error');
      });
  ...
  function updateConsent() {
    const consentGranted = hasThirdPartyConsent();
    if (consentGranted) {
      loadApi();
    }
    if (previousConsent === true && consentGranted === false && (window.google || document.getElementById('cfuchs-google-maps-api'))) {
  ...
  function startGoogleMapsConsent() {
    ...
    updateConsent();
    window.setInterval(updateConsent, 1000);
    window.addEventListener('focus', updateConsent);
  }
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', startGoogleMapsConsent, {
      once: true
    });
  } else {
...
/***/ "./assets/src/js/partials/load-more-jobs.js"
/*!**************************************************!*\
  !*** ./assets/src/js/partials/load-more-jobs.js ***!
  \**************************************************/
() {
...
jQuery(function () {
  ...
  function toggleSectionVisibility() {
    ...
    params.has('s') || currentCategory || currentRegion || currentStatus ? section.removeClass('hide-section') : section.addClass('hide-section');
  }
  ...
  function fetchJobs(reset = false) {
    ...
    jQuery.ajax({
      ...
      data: {
        ...
        no_jobs_message: typeof noJobsMessage !== 'undefined' ? noJobsMessage : 'No Jobs Found.'
      },
      success(res) {
...
/***/ "./assets/src/js/partials/load-more-projects.js"
/*!******************************************************!*\
  !*** ./assets/src/js/partials/load-more-projects.js ***!
  \******************************************************/
() {
...
/***/ "./assets/src/js/partials/load-more-reference.js"
/*!*******************************************************!*\
  !*** ./assets/src/js/partials/load-more-reference.js ***!
  \*******************************************************/
() {
...
jQuery(function () {
  ...
  function updateURL() {
    const params = new URLSearchParams();
    if (currentSearch !== '' || currentCategory || currentRegion || currentStatus) {
      params.set('s', currentSearch);
    }
    if (currentCategory) params.set('category', currentCategory);
    if (currentRegion) params.set('region', currentRegion);
    if (currentStatus) params.set('status', currentStatus);
    history.pushState(null, '', params.toString() ? `${location.pathname}?${params}` : location.pathname);
  }
  function toggleSectionVisibility() {
    const params = new URLSearchParams(window.location.search);
    params.has('s') || currentCategory || currentRegion || currentStatus ? section.removeClass('hide-section') : section.addClass('hide-section');
    params.has('s') || currentCategory || currentRegion || currentStatus ? contentSection.addClass('hide-section') : contentSection.removeClass('hide-section');
  }
...
/* harmony import */ var _vendors_lity_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../vendors/lity.js */ "./assets/src/js/vendors/lity.js");
/* harmony import */ var _vendors_lity_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_vendors_lity_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _vendors_masonry_min__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../vendors/masonry.min */ "./assets/src/js/vendors/masonry.min.js");
/* harmony import */ var _vendors_masonry_min__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_vendors_masonry_min__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _vendors_imagesloaded_pkgd_min__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../vendors/imagesloaded.pkgd.min */ "./assets/src/js/vendors/imagesloaded.pkgd.min.js");
/* harmony import */ var _vendors_imagesloaded_pkgd_min__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_vendors_imagesloaded_pkgd_min__WEBPACK_IMPORTED_MODULE_7__);
/**
 * Sticky Header
    ...
    wipe.one('transitionend', function (event) {
      ...
      requestAnimationFrame(function () {
        requestAnimationFrame(function () {
          ...
          loader.removeClass('wipe-in').addClass('wipe-out');
          wipe.one('transitionend', function (exitEvent) {
            if (exitEvent.originalEvent.propertyName !== 'transform') {
              return;
            }
...
jQuery(function () {
  ...
  jQuery('.header-nav').on('click', '.submenu-icon', function (e) {
    ...
    // Close siblings
    parentLi.siblings('.active').removeClass('active').children('ul').stop(true, true).slideUp(300, function () {
  ...
  jQuery('.submenu-icon').hover(function () {
    // mouseenter
...
/***/ "./assets/src/js/vendors/imagesloaded.pkgd.min.js"
/*!********************************************************!*\
  !*** ./assets/src/js/vendors/imagesloaded.pkgd.min.js ***!
  \********************************************************/
...
{}
  ...
  function lity(target, options, opener) {
    ...
    const instance = new Lity(target, $.extend({}, opener.data('lity-options') || opener.data('lity'), options), opener, document.activeElement);
    if (!target.preventDefault) {
      return instance;
    }
  }
...
/***/ "./assets/src/js/vendors/masonry.min.js"
/*!**********************************************!*\
  !*** ./assets/src/js/vendors/masonry.min.js ***!
  \**********************************************/
(module, exports, __webpack_require__) {
