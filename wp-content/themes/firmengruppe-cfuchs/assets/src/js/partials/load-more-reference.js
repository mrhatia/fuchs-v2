jQuery(function () {
	...
	const contentSection = jQuery('#reference-content-section');
	...
	function toggleSectionVisibility() {
		...
		params.has('s') || currentCategory || currentRegion || currentStatus
			? contentSection.addClass('hide-section')
			: contentSection.removeClass('hide-section');
	}
	...
	function fetchPosts(reset = false) {
		...
		jQuery.ajax({
			...
			success(res) {
				reset ? container.html(res.data.html) : container.append(res.data.html);
