<?php
/**
 * Template Name: Einblicke
 * Template Post Type: page
 *
 * This template is for displaying einblicke page.
 *
...
$fh_var_tenb_slides     = $bst_fields['fh_var_tenb_slides'] ?? null;

	$slide_count = count( $fh_var_tenb_slides );
